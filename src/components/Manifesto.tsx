...
export default function Manifesto() {
  const pillars = [
    ...
    },
    {
      ...
      desc: "Why should multi-national corporations have all the custom developer tooling? CetaListing provides the exact same automated cataloging horsepower to local Surat wholesalers, free of entry barriers.",
